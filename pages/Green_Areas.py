...
# green area map
espacios_verdes = pd.read_csv('espacios_verdes.csv', sep=';' )
...
contenedores_aceite = pd.read_csv('contenedores_aceite.csv', sep=';' )
...
contenedores_pilas = pd.read_csv('contenedores_pilas.csv', sep=';', encoding="cp437",errors='ignore')
...
contenedores_ropa = pd.read_csv('contenedores_ropa.csv', sep=';' )
