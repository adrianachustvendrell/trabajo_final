...
# CODE
#------------------------------------------------------------------------------------------------------------------------
with open('distritos.json', encoding='utf8') as f:
...
#-----------------------------------------------BUS----------------------------------------------------------------------
emt_data = pd.read_csv('emt_con_distritos.csv', encoding='utf8')
emt_data = emt_data.rename(columns={emt_data.columns[4]:'Denominacion'})
...
if transporte_seleccionado == "Bus" and distrito_seleccionado != "All":
    ...
    for index, row in bus_stops.iterrows():
        ...
        stop_name = row['Denominacion']  # Obtener el nombre de la parada
...
subway_data = pd.read_csv('subway_con_distritos.csv', encoding='utf8')
subway_data = subway_data.rename(columns={subway_data.columns[1]:'Denominacion'})
...
bike_data = pd.read_csv('bikes_con_distritos.csv', encoding='utf8')
